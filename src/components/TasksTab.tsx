          ...
          <div className="flex">
            <motion.button
              ...
              className={`flex-1 py-2 sm:py-3 px-2 sm:px-4 text-center font-medium text-xs sm:text-sm ${
                activeTab === 'tasks' ? 'text-yellow-400 border-b-2 border-yellow-400' : 'text-white/70'
              }`}
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className={`flex-1 py-2 sm:py-3 px-2 sm:px-4 text-center font-medium text-xs sm:text-sm ${
                activeTab === 'rewards' ? 'text-yellow-400 border-b-2 border-yellow-400' : 'text-white/70'
              }`}
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className={`flex-1 py-2 sm:py-3 px-2 sm:px-4 text-center font-medium text-xs sm:text-sm ${
                activeTab === 'points' ? 'text-yellow-400 border-b-2 border-yellow-400' : 'text-white/70'
              }`}
          ...
          {activeTab === 'tasks' && (
            <div className="p-3 sm:p-6">
              ...
              >
                ...
                >
                  <div 
                    className={`p-1 sm:p-2 rounded-lg relative overflow-hidden ${
                      getCurrentLevel() >= 1 
             ...
             >
               ...
               <div className="divide-y divide-yellow-400/10">
                 ...
                 <motion.div 
                   ...
                   className="p-3 sm:p-4 flex items-center"
                 >
                   <div className={`min-w-[28px] h-7 sm:min-w-[32px] sm:h-8 flex items-center justify-center rounded-full ${isSolanaWalletConnected ? 'bg-yellow-400' : 'bg-gray-800'} mr-2 sm:mr-4`}>
                   ...
                   <div className="flex-1 min-w-0">
                     <div className="flex items-center">
                       <WalletMultiButton 
                         ...
                         style={{
                           backgroundColor: isSolanaWalletConnected ? "#d4af37" : "#eab308",
                           color: "black",
                           fontFamily: "inherit",
                           height: "36px",
                           padding: "0 12px",
                           fontSize: "12px",
                           borderRadius: "8px",
                           cursor: isSolanaWalletConnected ? "default" : "pointer",
                           display: "flex",
                           alignItems: "center",
                           fontWeight: "600",
                           transition: "background-color 0.2s ease",
                           opacity: isSolanaWalletConnected ? 0.7 : 1,
                           maxWidth: "100%",
                           overflow: "hidden",
                       ...
                       >
                         {isSolanaWalletConnected ? "Wallet Connected" : "Connect Solana Wallet"}
                       </WalletMultiButton>
                     </div>
                   </div>
                   <div className="ml-2 sm:ml-4 flex items-center text-yellow-400 whitespace-nowrap">
               ...
               <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                 ...
                 <motion.div 
                   ...
                   className={`p-3 sm:p-4 rounded-xl border ${
                     getCurrentLevel() >= 1 ? 'bg-gradient-to-b from-yellow-400/20 to-transparent border-yellow-400' : 'bg-gray-800 border-gray-700'
                   }`}
                 >
                 ...
                 <motion.div 
                   ...
                   whileHover={{ y: -5, boxShadow: "0 10px 15px -3px rgba(234, 179, 8, 0.3)" }}
                   className={`p-3 sm:p-4 rounded-xl border ${
                     getCurrentLevel() >= 2 ? 'bg-gradient-to-b from-yellow-400/20 to-transparent border-yellow-400' : 'bg-gray-800 border-gray-700'
                   }`}
                 >
                   <div className="flex justify-between items-center mb-2 sm:mb-3">
                 ...
                 <motion.div 
                   ...
                   whileHover={{ y: -5, boxShadow: "0 10px 15px -3px rgba(234, 179, 8, 0.3)" }}
                   className={`p-3 sm:p-4 rounded-xl border ${
                     getCurrentLevel() >= 3 ? 'bg-gradient-to-b from-yellow-400/20 to-transparent border-yellow-400' : 'bg-gray-800 border-gray-700'
                   }`}
                 >
                   <div className="flex justify-between items-center mb-2 sm:mb-3">
